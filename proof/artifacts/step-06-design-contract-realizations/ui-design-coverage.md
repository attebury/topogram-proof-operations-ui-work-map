...
| widget_activity_timeline | ios | any | comfortable | ops.ios.timeline | implementation_owned | loading, empty, error | review_required |
| widget_activity_timeline | web | wide | comfortable | ops.timeline.auditTrail | rendered | loading, empty, error | review_required |
...
| widget_alert_banner | web | wide | compact | ops.alerts.liveBanner | rendered | loading, empty, error | review_required |
| widget_assignment_form | android | any | comfortable | ops.android.assignmentSheet | implementation_owned | loading, empty, error | review_required |
| widget_assignment_form | ios | any | comfortable | ops.ios.assignmentSheet | implementation_owned | loading, empty, error | review_required |
| widget_assignment_form | web | narrow | comfortable | ops.forms.assignmentSheet | contract_only | loading, empty | review_required |
| widget_assignment_form | web | wide | comfortable | ops.forms.assignmentDrawer | rendered | loading, empty, error | review_required |
| widget_card_list | android | any | comfortable | ops.android.queueCards | unsupported | loading, empty | review_required |
| widget_card_list | ios | any | comfortable | ops.ios.queueList | implementation_owned | loading, empty, error | review_required |
| widget_card_list | web | narrow | comfortable | ops.queue.mobileCards | contract_only | loading, empty | review_required |
| widget_card_list | web | wide | comfortable | ops.queue.priorityCards | rendered | loading, empty, error | review_required |
| widget_command_toolbar | android | any | comfortable | ops.android.actionRow | implementation_owned | loading, empty, error | review_required |
| widget_command_toolbar | ios | any | comfortable | ops.ios.commandBar | implementation_owned | loading, empty, error | review_required |
| widget_command_toolbar | web | narrow | compact | ops.commandToolbar.overflow | rendered | loading, empty, error | review_required |
| widget_command_toolbar | web | wide | compact | ops.commandToolbar.desktop | rendered | loading, empty, error | review_required |
...
| widget_data_grid | web | wide | compact | ops.table.dataGrid | rendered | loading, empty, error | review_required |
| widget_detail_panel | android | any | comfortable | ops.android.detailSheet | implementation_owned | loading, empty, error | review_required |
| widget_detail_panel | ios | any | comfortable | ops.ios.detailSheet | implementation_owned | loading, empty, error | review_required |
| widget_detail_panel | web | wide | comfortable | ops.settings.sectionPanel | contract_only | loading, empty | review_required |
| widget_detail_panel | web | wide | comfortable | ops.detail.summaryPanel | rendered | loading, empty, error | review_required |
| widget_detail_panel | web | wide | compact | ops.detail.inspector | rendered | loading, empty, error | review_required |
| widget_filter_panel | android | any | unspecified | (missing) | missing_platform | (none) | review_required |
| widget_filter_panel | ios | any | comfortable | ops.ios.filterSheet | implementation_owned | loading, empty, error | review_required |
| widget_filter_panel | web | narrow | comfortable | ops.filters.sheet | contract_only | loading, empty | review_required |
| widget_filter_panel | web | wide | compact | ops.filters.rail | rendered | loading, empty, error | review_required |
| widget_kpi_summary_cards | android | any | unspecified | (missing) | missing_platform | (none) | review_required |
| widget_kpi_summary_cards | ios | any | comfortable | ops.ios.metricCards | implementation_owned | loading, empty, error | review_required |
| widget_kpi_summary_cards | web | narrow | comfortable | ops.kpi.summaryCarousel | contract_only | loading, empty | review_required |
| widget_kpi_summary_cards | web | wide | comfortable | ops.kpi.summaryGrid | rendered | loading, empty, error | review_required |
| widget_schedule_calendar | android | any | comfortable | ops.android.scheduleCalendar | implementation_owned | loading, empty, error | review_required |
| widget_schedule_calendar | ios | any | comfortable | ops.ios.scheduleCalendar | implementation_owned | loading, empty, error | review_required |
| widget_schedule_calendar | web | narrow | comfortable | ops.calendar.agendaList | unsupported | loading | review_required |
| widget_schedule_calendar | web | wide | comfortable | ops.calendar.scheduleBoard | rendered | loading, empty, error | review_required |
...
| widget_status_board | web | wide | compact | ops.board.statusLanes | rendered | loading, empty, error | review_required |
...
| design_missing_accessibility | widget_assignment_form | web | ops.forms.assignmentDrawer | Widget 'widget_assignment_form' has no authored accessibility obligation. |
| design_missing_i18n | widget_assignment_form | web | ops.forms.assignmentSheet | Widget 'widget_assignment_form' has no authored message key. |
| design_missing_i18n | widget_assignment_form | web | ops.forms.assignmentDrawer | Widget 'widget_assignment_form' has no authored message key. |
...
| design_missing_accessibility | widget_card_list | android | ops.android.queueCards | Widget 'widget_card_list' has no authored accessibility obligation. |
| design_missing_i18n | widget_card_list | android | ops.android.queueCards | Widget 'widget_card_list' has no authored message key. |
...
| design_missing_accessibility | widget_card_list | ios | ops.ios.queueList | Widget 'widget_card_list' has no authored accessibility obligation. |
| design_missing_i18n | widget_card_list | ios | ops.ios.queueList | Widget 'widget_card_list' has no authored message key. |
| design_behavior_review_required | widget_card_list | web | ops.queue.mobileCards | Behavior 'filtering' is 'contract_only'. |
| design_missing_accessibility | widget_card_list | web | ops.queue.mobileCards | Widget 'widget_card_list' has no authored accessibility obligation. |
| design_missing_accessibility | widget_card_list | web | ops.queue.priorityCards | Widget 'widget_card_list' has no authored accessibility obligation. |
| design_missing_i18n | widget_card_list | web | ops.queue.mobileCards | Widget 'widget_card_list' has no authored message key. |
| design_missing_i18n | widget_card_list | web | ops.queue.priorityCards | Widget 'widget_card_list' has no authored message key. |
...
| design_missing_accessibility | widget_command_toolbar | android | ops.android.actionRow | Widget 'widget_command_toolbar' has no authored accessibility obligation. |
| design_missing_i18n | widget_command_toolbar | android | ops.android.actionRow | Widget 'widget_command_toolbar' has no authored message key. |
| design_missing_accessibility | widget_command_toolbar | ios | ops.ios.commandBar | Widget 'widget_command_toolbar' has no authored accessibility obligation. |
| design_missing_i18n | widget_command_toolbar | ios | ops.ios.commandBar | Widget 'widget_command_toolbar' has no authored message key. |
...
| design_missing_accessibility | widget_command_toolbar | web | ops.commandToolbar.overflow | Widget 'widget_command_toolbar' has no authored accessibility obligation. |
| design_missing_accessibility | widget_command_toolbar | web | ops.commandToolbar.desktop | Widget 'widget_command_toolbar' has no authored accessibility obligation. |
| design_missing_i18n | widget_command_toolbar | web | ops.commandToolbar.overflow | Widget 'widget_command_toolbar' has no authored message key. |
| design_missing_i18n | widget_command_toolbar | web | ops.commandToolbar.desktop | Widget 'widget_command_toolbar' has no authored message key. |
...
| design_missing_accessibility | widget_data_grid | web | ops.table.cardFallback | Widget 'widget_data_grid' has no authored accessibility obligation. |
| design_missing_accessibility | widget_data_grid | web | ops.table.dataGrid | Widget 'widget_data_grid' has no authored accessibility obligation. |
| design_missing_i18n | widget_data_grid | web | ops.table.cardFallback | Widget 'widget_data_grid' has no authored message key. |
| design_missing_i18n | widget_data_grid | web | ops.table.dataGrid | Widget 'widget_data_grid' has no authored message key. |
...
| design_missing_accessibility | widget_detail_panel | android | ops.android.detailSheet | Widget 'widget_detail_panel' has no authored accessibility obligation. |
| design_missing_i18n | widget_detail_panel | android | ops.android.detailSheet | Widget 'widget_detail_panel' has no authored message key. |
| design_missing_accessibility | widget_detail_panel | ios | ops.ios.detailSheet | Widget 'widget_detail_panel' has no authored accessibility obligation. |
| design_missing_i18n | widget_detail_panel | ios | ops.ios.detailSheet | Widget 'widget_detail_panel' has no authored message key. |
| design_missing_accessibility | widget_detail_panel | web | ops.detail.inspector | Widget 'widget_detail_panel' has no authored accessibility obligation. |
| design_missing_accessibility | widget_detail_panel | web | ops.settings.sectionPanel | Widget 'widget_detail_panel' has no authored accessibility obligation. |
| design_missing_accessibility | widget_detail_panel | web | ops.detail.summaryPanel | Widget 'widget_detail_panel' has no authored accessibility obligation. |
| design_missing_i18n | widget_detail_panel | web | ops.detail.inspector | Widget 'widget_detail_panel' has no authored message key. |
| design_missing_i18n | widget_detail_panel | web | ops.settings.sectionPanel | Widget 'widget_detail_panel' has no authored message key. |
| design_missing_i18n | widget_detail_panel | web | ops.detail.summaryPanel | Widget 'widget_detail_panel' has no authored message key. |
...
| design_missing_accessibility | widget_filter_panel | ios | ops.ios.filterSheet | Widget 'widget_filter_panel' has no authored accessibility obligation. |
| design_missing_i18n | widget_filter_panel | ios | ops.ios.filterSheet | Widget 'widget_filter_panel' has no authored message key. |
...
| design_missing_accessibility | widget_filter_panel | web | ops.filters.sheet | Widget 'widget_filter_panel' has no authored accessibility obligation. |
| design_missing_accessibility | widget_filter_panel | web | ops.filters.rail | Widget 'widget_filter_panel' has no authored accessibility obligation. |
| design_missing_i18n | widget_filter_panel | web | ops.filters.sheet | Widget 'widget_filter_panel' has no authored message key. |
| design_missing_i18n | widget_filter_panel | web | ops.filters.rail | Widget 'widget_filter_panel' has no authored message key. |
...
| design_missing_accessibility | widget_kpi_summary_cards | ios | ops.ios.metricCards | Widget 'widget_kpi_summary_cards' has no authored accessibility obligation. |
| design_missing_i18n | widget_kpi_summary_cards | ios | ops.ios.metricCards | Widget 'widget_kpi_summary_cards' has no authored message key. |
| design_behavior_review_required | widget_kpi_summary_cards | web | ops.kpi.summaryCarousel | Behavior 'selection' is 'contract_only'. |
| design_missing_accessibility | widget_kpi_summary_cards | web | ops.kpi.summaryCarousel | Widget 'widget_kpi_summary_cards' has no authored accessibility obligation. |
| design_missing_accessibility | widget_kpi_summary_cards | web | ops.kpi.summaryGrid | Widget 'widget_kpi_summary_cards' has no authored accessibility obligation. |
| design_missing_i18n | widget_kpi_summary_cards | web | ops.kpi.summaryCarousel | Widget 'widget_kpi_summary_cards' has no authored message key. |
| design_missing_i18n | widget_kpi_summary_cards | web | ops.kpi.summaryGrid | Widget 'widget_kpi_summary_cards' has no authored message key. |
...
| design_missing_accessibility | widget_schedule_calendar | android | ops.android.scheduleCalendar | Widget 'widget_schedule_calendar' has no authored accessibility obligation. |
| design_missing_i18n | widget_schedule_calendar | android | ops.android.scheduleCalendar | Widget 'widget_schedule_calendar' has no authored message key. |
| design_missing_accessibility | widget_schedule_calendar | ios | ops.ios.scheduleCalendar | Widget 'widget_schedule_calendar' has no authored accessibility obligation. |
| design_missing_i18n | widget_schedule_calendar | ios | ops.ios.scheduleCalendar | Widget 'widget_schedule_calendar' has no authored message key. |
| design_behavior_review_required | widget_schedule_calendar | web | ops.calendar.agendaList | Behavior 'selection' is 'unsupported'. |
| design_missing_accessibility | widget_schedule_calendar | web | ops.calendar.agendaList | Widget 'widget_schedule_calendar' has no authored accessibility obligation. |
| design_missing_accessibility | widget_schedule_calendar | web | ops.calendar.scheduleBoard | Widget 'widget_schedule_calendar' has no authored accessibility obligation. |
| design_missing_i18n | widget_schedule_calendar | web | ops.calendar.agendaList | Widget 'widget_schedule_calendar' has no authored message key. |
| design_missing_i18n | widget_schedule_calendar | web | ops.calendar.scheduleBoard | Widget 'widget_schedule_calendar' has no authored message key. |
...
| design_missing_accessibility | widget_status_board | ios | ops.ios.statusBoard | Widget 'widget_status_board' has no authored accessibility obligation. |
| design_missing_i18n | widget_status_board | ios | ops.ios.statusBoard | Widget 'widget_status_board' has no authored message key. |
...
| design_missing_accessibility | widget_status_board | web | ops.board.statusLanes | Widget 'widget_status_board' has no authored accessibility obligation. |
| design_missing_i18n | widget_status_board | web | ops.board.statusLanes | Widget 'widget_status_board' has no authored message key. |
